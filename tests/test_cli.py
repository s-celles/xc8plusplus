...
'''
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.cpp', delete=False) as input_file:
            input_file.write(cpp_content)
            input_file.flush()
            input_file_path = input_file.name
            
        with tempfile.NamedTemporaryFile(mode='w', suffix='.c', delete=False) as output_file:
        ...
        try:
            ...
            assert result.exit_code in [0, 1]  # 0 for success, 1 for transpilation failure
